...
plot_results <- function(df) {
  ...
  ggplot_object <- ggplot(df, aes(x=Date)) + 
    ...
    scale_y_continuous(labels = scales::label_comma(), limits=c(-200000, 400000), breaks=seq(-200000, 400000, by=100000)) +
...
ggsave("Outputs/Graphs/Cluster_Analysis(Area).png", combined_area, width = 6, height = 6)
